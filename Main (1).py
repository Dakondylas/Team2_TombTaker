...
race = input("choose your race White,Black,Asian, or Hispanic:")




while True:
    #story begins and allows the player to select there desired race
    if race.lower() == 'white':
